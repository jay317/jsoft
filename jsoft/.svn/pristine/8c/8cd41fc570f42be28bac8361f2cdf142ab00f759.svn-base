        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" id="addForm" method="post" action="<?php echo site_url('optics/optOrderSave');?>">         
              <div class="box-body">
				<div class="row">
					<div class="col-md-4 panel panel-info col-md-offset-3 printArea">
						<?php $settingDetails=$this->session->userdata('settingDetails');?>
						<h4 style="padding-top:10px; margin:0px;"><center><?php if($settingDetails){ echo strtoupper($settingDetails->icw_shop_name0317);}?></center></h4>
