			  ...
			  <span class="span_msg"style="display:none;"></span>
				...
				<div class="form-group">
				  ...
				  <span class="input-group-addon">
                    ...
                    <input type="password" value="" class="form-control" name="uPwd" id="uPwd" required placeholder="Password">
                  </div>
                </div>
				<div class="form-group">
				  ...
				  <span class="input-group-addon">
                    ...
                    <input type="password" value="" class="form-control" name="unPwd" id="unPwd" required placeholder="Password">
                  </div>
                </div>			
           ...
           e.preventDefault();  		 				
                $.ajax({  
                     ...
                     {  
						...
						{						        						 
							$(".span_msg2").show();							
							$(".span_msg2").html("<strong>Password Successfully Changed &nbsp;&nbsp;&nbsp;<i class='fa fa-check' aria-hidden='true'></i></strong>").css("color","white");
							$("#uPwd").val("");
							$("#unPwd").val("");
							$(".span_msg2").addClass('badge badge-success');
						}else if(data ==0){
							$(".span_msg2").show();
							$(".span_msg2").html("<strong>Password Not Changed &nbsp;&nbsp;&nbsp;<i class='fa fa-times' aria-hidden='true'></i></strong>").css("color","white");							
							$(".span_msg2").addClass('badge badge-warning');
							}else if(data ==2){
							$(".span_msg2").show();
							$(".span_msg2").html("<strong>Current Password Not Match &nbsp;&nbsp;&nbsp;<i class='fa fa-times' aria-hidden='true'></i></strong>").css("color","white");						
							$(".span_msg2").addClass('badge badge-warning');
							}                             
                     }  
                });	
           ...
           e.preventDefault();            
                $.ajax({  
                     ...
                     {  
						...
						{						        						 
							$(".span_msg").show();
							$(".span_msg").html("<strong>Successfully Updated &nbsp;&nbsp;&nbsp;<i class='fa fa-check' aria-hidden='true'></i></strong>").css("color","white");
							$(".span_msg").addClass('badge badge-success');	
							$("#userFullName").load(location.href + " #userFullName");
							$("#userName").load(location.href + " #userName");
						}else if(data == '0'){
							$(".span_msg").html("<strong>Not Updated &nbsp;&nbsp;&nbsp;<i class='fa fa-times' aria-hidden='true'></i></strong>").css("color","white");
							$(".span_msg2").addClass('badge badge-warning');
						}                            
                     }  
                });    
