				  ...
				  <td>
					<?php if($list_type=='lab'){ ?>
						...
						<?php }else{?>
							...
							<a class="btn btn-danger btn-sm" onclick="deleteOrder(<?php echo $id=$row->icw_tai_id0317;?>);">Delete</a>
							<?php }?>
				  </td>
                </tr>
				<?php } ?>
