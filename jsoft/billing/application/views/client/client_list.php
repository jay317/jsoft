				 ...
				 <tr>
				  ...
				  <div class="btn-group">
					  ...
					  <ul class="dropdown-menu" role="menu">
						...
						<li><a onclick="deleteClient('<?php echo $id=$row->icw_clientId0317;?>');" style="cursor: pointer"><i class="fa fa-trash text-danger" aria-hidden="true"></i><span class="text-danger">Delete Client</span></a></li>						
					  </ul>
					</div>
				  </td>					
				</tr>
