          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" id="addForm" method="post" action="<?php echo site_url('optics/optOrderSave');?>">         
					...
					<div class="col-md-5 col-md-offset-3">
						...
						<table class="table table-responsive panel panel-info" style="margin-top:0px">
							<tr><td>
								...
								<td><strong>Date</strong>&nbsp;<p><?php echo getDateFormat_d($rslt->icw_opt_date0317);?></p>
								</td>
							</tr>
							<tr><td>
							...
							<tr><td>
								<strong>Total Amount</strong>&nbsp;<p><?php echo getCurrencyDouble($rslt->icw_opt_totalAmt0317);?></p>
								</td>
								<td><?php if($rslt->icw_opt_advance0317==0 && $rslt->icw_opt_balance0317==0){?><span class="badge badge-success">Paid &nbsp;<i class="fa fa-check" aria-hidden="true"></i></span><?php }?></td>
							</tr>
							<tr><td>
								<strong>Advanced</strong>&nbsp;<p><?php echo getCurrencyDouble($rslt->icw_opt_advance0317);?></p>
								</td>
								<td><strong>Balance</strong>&nbsp;<p><?php echo getCurrencyDouble($rslt->icw_opt_balance0317);?></p>
								</td>
							</tr>
						</table>
              ...
              <div class="row" style="padding-bottom:20px;">
						<a href="<?php echo site_url('optics/orderList?list_type=shop');?>" class="btn btn-info col-md-offset-5">Back</a>
