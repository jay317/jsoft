       ...
       <div class="box-j2 col-md-7 panel1 panel-info1" id="printarea"> 
	       <!-- j hidden data -->
	       		...
	       		<input type="hidden" name="client_country" id="client_country">
					...
					<input type="hidden" name="shopLogo" id="shopLogo" value="<?php if($settingDetails->icw_shop_bLogo_0317!=''){echo $settingDetails->icw_shop_bLogo_0317;}?>">
					<input type="hidden" name="shopName" id="shopName" value="<?php if($settingDetails->icw_shop_name0317!=''){echo $settingDetails->icw_shop_name0317;}?>">
					<input type="hidden" name="shopMobile" id="shopMobile" value="<?php if($settingDetails->icw_shop_mobile0317!=''){echo $settingDetails->icw_shop_mobile0317;}?>">
					<input type="hidden" name="shopPhone" id="shopPhone" value="<?php if($settingDetails->icw_shop_phone0317!=''){echo $settingDetails->icw_shop_phone0317;}?>">
					<input type="hidden" name="shopGstin" id="shopGstin" value="<?php if($settingDetails->icw_shop_gstin0317!=''){echo $settingDetails->icw_shop_gstin0317;}?>">
					<input type="hidden" name="shopAddr" id="shopAddr" value="<?php if($settingDetails->icw_shop_Address0317!=''){echo $settingDetails->icw_shop_Address0317;}?>">
					<input type="hidden" name="shopTC" id="shopTC" value="<?php if($settingDetails->icw_shop_TermCondition0317!=''){echo $settingDetails->icw_shop_TermCondition0317;}?>">
	        <!-- /j .hidden data -->     
            	...
            	<div class="col-md-4  col-md-offset-4" style="margin-top:30px;margin-bottom:10px;">           		
            		<div class="action-box">
		            	...
		            	<!-- <button type="submit" class="btn btn-primary print">Print</button> -->
		            	 <a href="<?php echo site_url('sale/invoicePrint?id='.$invoCount);?>" target="_blank" class="btn btn-primary print">Print</a> 
            		</div>
            	</div>
               </div>
             </div>
	...
	if(optMode=='')
	 {
		 ...
		 $("#total_jTax").html(amtAftrTax.toFixed(2));
		 $("#total_jTaxJ").val(amtAftrTax.toFixed(2));
	 }
