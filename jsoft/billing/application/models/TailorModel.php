...
function invoice_list(){
	$settingDetails=$this->session->userdata('settingDetails');
		$shopId=$settingDetails->icw_shopId0317;
	$this->db->select('icw_tai_Id0317 as id, icw_tai_totalAmt0317 as total, icw_tai_advance0317 as advance, icw_tai_balance0317 as balance, icw_tai_cMobile0317 as mobile, icw_tai_date0317 as date');
	$this->db->from('icw_tailor_order_0317');
	$this->db->where('icw_shopId0317',$shopId);
	$rslt=$this->db->get();
		return $rslt->result();
